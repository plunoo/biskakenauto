...
app.get('/api/status', auth_1.optionalAuth, (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
        ...
        const serviceStatuses = {
            ...
            sms: smsService_1.smsService.getServiceStatus(),
            payment: paymentService_1.paymentService.getServiceStatus(),
            ai: {
...
app.post('/api/webhooks/paystack', express_1.default.raw({ type: 'application/json' }), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
...
app.get('/api/public/payment/verify/:reference', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
...
app.use('/temp', auth_1.authenticate, express_1.default.static(path_1.default.join(__dirname, '../temp')));
// Mobile Money USSD callback endpoint (if needed for some providers)
app.post('/api/callbacks/mobile-money', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    try {
...
const gracefulShutdown = async (signal) => {
    ...
    try {
        ...
        await pdfService_1.pdfService.cleanupOldFiles(1); // Clean files older than 1 hour
...
✅ Server ready for connections!
  `);
    ...
    const services = {
        SMS: smsService_1.smsService.getServiceStatus().isConfigured,
        Payment: paymentService_1.paymentService.getServiceStatus().paystack.configured,
        AI: Boolean(process.env.OPENAI_API_KEY),
        USDT: paymentService_1.paymentService.getServiceStatus().usdt.configured
    };
    console.log('\n🔧 Service Status:');
